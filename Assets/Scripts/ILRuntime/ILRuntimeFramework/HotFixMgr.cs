...
public class HotFixMgr : UnityAutoGeneratedSingleton<HotFixMgr>
{
    ...
    private void InitializeILRuntime()
    {
        ...
        m_appdomain.DelegateManager.RegisterMethodDelegate<bool, SpriteAtlas>();
        m_appdomain.DelegateManager.RegisterMethodDelegate<bool, GameObject>();


        //ILRuntime.Runtime.Generated.CLRBindings.Initialize(m_appdomain);

        ILRuntime.Runtime.CLRBinding.CLRBindingUtils.Initialize(m_appdomain);
