...
[CustomEditor(typeof(HotFixMonoBehaviourAdapter.Adaptor), true)]
public class HotFixMonoBehaviourAdapterEditor : UnityEditor.UI.GraphicEditor
{
     public override void OnInspectorGUI()
    {
        serializedObject.Update();
        HotFixMonoBehaviourAdapter.Adaptor clr = target as HotFixMonoBehaviourAdapter.Adaptor;
