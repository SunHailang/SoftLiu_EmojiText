...
public class HotFixMgr : MonoBehaviour
{
    ...
    private System.IO.MemoryStream fs = null;
    private System.IO.MemoryStream p = null;
    ...
    private void OnHotFixLoaded()
    {
        ...
        appdomain.Invoke("HotFix_Project.HelloWorld", "StaticTestMethod", null, null);

        Debug.Log("调用带参数的静态方法");
        //调用带参数的静态方法
        appdomain.Invoke("HotFix_Project.HelloWorld", "StaticTestMethod", null, 123);
    }
