...
{
    unsafe class AssetBundleRequestAdapter
    {
        ...
        static StackObject* get_asset_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.AssetBundleRequest instance_of_this_method = 
                (UnityEngine.AssetBundleRequest) typeof(UnityEngine.AssetBundleRequest).CheckCLRTypes(
