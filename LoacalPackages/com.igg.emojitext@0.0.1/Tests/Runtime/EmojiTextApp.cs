...
namespace Igg.EmojiText.Runtime.Tests
{

    public class EmojiTextApp : MonoBehaviour
    {
        private const string m_textStr =
            @"Hello World [0#emoji_19#emoji][1#emoji_2#emoji]1111456456456456[1#emoji_3#emoji]4564[-1#我是超链接1号-点我#https:\\www.baidu.com]564564564[0#emoji_35#emoji]5645645645[-2#我是超链接2号-点我#https:\\www.igg.com]6456456[0#emoji_38#emoji]456456456";
        ...
        {
            UiEmojiText text = UnityEngine.GameObject.Instantiate(m_textPrefab, m_parentTrans);
